  ...
  return (
    <div className="fixed top-0 z-20 flex w-full bg-slate-900 bg-opacity-40 text-lg font-semibold text-opacity-100">
      <div className="mx-auto flex">
        <Link href="/#menu">
          <a className="w-6 sm:w-auto md:p-2 md:px-4 hover:text-white hover:transition-colors hover:duration-300 invisible md:visible">
            Home
          </a>
        </Link>
        <Link href="/#about">
          <a className="p-1 md:p-2 md:px-4 hover:text-white hover:transition-colors hover:duration-300">
            About
          </a>
        </Link>
        <Link href="/#resume">
